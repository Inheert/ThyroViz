import script.clinical_trials.ct_const
from script.clinical_trials.ct_helpers import *
from script.clinical_trials.ct_const import *
import pandas as pd
import os
import glob
...
def appLaunch():
    script.clinical_trials.ct_const.loading = True
