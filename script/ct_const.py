...
class_dict = {
    ...
    "Health care Institution": ["HOSPITAL", "CANCER CENTER", "MEDICAL CENTER", "CENTRE LEON BERARD", "GUSTAVE ROUSSY", "CHU", "ZIEKENHUIS", "HOPITAUX", "HOSPICES", "OSPEDALIERO", "OSPEDALIERA", "CENTRE FRANCOIS BACLESSE", "MAYO CLINIC", "DANA-FARBER CANCER INSTITUTE"],
